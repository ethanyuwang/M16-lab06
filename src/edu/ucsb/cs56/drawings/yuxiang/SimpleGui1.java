package edu.ucsb.cs56.drawings.yuxiang;
...
public class SimpleGui1 {
    ...
    */
	...
	JButton button = new JButton("Click me and see what happens!") ;
	
	java.awt.Color myColor = new java.awt.Color(045,255,000);   // R, G, B values.
